...
\end{tabular}
\caption{Matriz generada para el cálculo de la similaridad entre dos películas. Se utiliza la información del director, los actores principales, las keywords que aparecen y los géneros a los que pertenece la película. Estos valores serán las coordenadas en el espacio vectorial definido por estas dimensiones.}
...
\begin{lstlisting}[language=Python, caption= {Obtención de las 30 mejores películas dada una por el usuario. Es una de las funciones principales del proyecto. Calcula las variables de entrada del algoritmo de KNN y devuelve los ID de las películas más cercanas a la dada.}]
